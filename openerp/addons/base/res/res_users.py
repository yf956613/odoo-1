...
class res_users(osv.osv):
    ...
    def user_systray_info(self, cr, uid, context=None):
        ...
        return {'current_company': user.company_id.name, 'other_allowed_companies': [(comp.id, comp.name) for comp in user.company_ids - user.company_id]} if display_company_name else False
