...
var ImageWidget = MediaWidget.extend({
    ...
    search: function (needle, noRender) {
        ...
        domain.push('|', ['name', '=', false], '!', ['name', '=like', '%.crop']);
        return this._rpc({
            model: 'ir.attachment',
            method: 'search_read',
            args: [],
            kwargs: {
                domain: domain,
                fields: ['name', 'name', 'mimetype', 'checksum', 'url', 'type', 'res_id', 'res_model', 'access_token'],
    ...
    _renderImages: function () {
        ...
        this.$('.existing-attachments').replaceWith(QWeb.render('wysiwyg.widgets.image.existing.attachment', {attachments: rows}));
...
var MediaDialog = Dialog.extend({
    ...
    isDocumentActive: function () { 
        return this.active === this.documentWidget;   
    },  
    /** 
    ...
    isIconActive: function () { 
        return this.active === this.iconWidget;   
    },  
    /** 
    ...
    isImageActive: function () {    
        return this.active === this.imageWidget;  
    },  
    /** 
    ...
    isVideoActive: function () {    
        return this.active === this.videoWidget;  
    },
