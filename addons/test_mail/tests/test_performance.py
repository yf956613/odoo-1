...
class TestMailPerformance(BaseMailPerformance):
    ...
    def test_create_mail(self):
        ...
        with self.assertQueryCount(__system__=2, demo=2):  # test_mail only: 2 - 2
    ...
    def test_create_mail_with_tracking(self):
        ...
        with self.assertQueryCount(__system__=7, demo=7):  # test_mail only: 7 - 7
...
class TestAdvMailPerformance(BaseMailPerformance):
    ...
    def test_adv_activity_full(self):
        ...
        with self.assertQueryCount(__system__=6, emp=6):  # com runbot: 10 - 13 // test_mail only: 6 - 6
        ...
        with self.assertQueryCount(__system__=19, emp=22):  # com runbot: 24 - 31 // test_mail only: 19 - 22
    ...
    def test_adv_activity_mixin(self):
        ...
        with self.assertQueryCount(__system__=7, emp=7):  # com runbot: 10 - 14 // test_mail only: 7 - 7
        ...
        with self.assertQueryCount(__system__=20, emp=22):  # com runbot: 26 - 31 // test_mail only: 20 - 22
    ...
    def test_message_assignation_email(self):
        ...
        with self.assertQueryCount(__system__=39, emp=40):  # com runbot: 52 - 54 // test_mail only: 39 - 40
            record.write({
    ...
    def test_message_assignation_inbox(self):
        record = self.env['mail.test.track'].create({'name': 'Test'})
        with self.assertQueryCount(__system__=27, emp=29):  # test_mail only: 27 - 29
            record.write({
                'user_id': self.user_test.id,
            })
    ...
    def test_message_log_with_post(self):
        ...
        with self.assertQueryCount(__system__=5, emp=6):  # test_mail only: 5 - 6
            record.message_post(
    ...
    def test_message_post_one_email_notification(self):
        ...
        with self.assertQueryCount(__system__=32, emp=33):  # com runbot: 44 - 47 // test_mail only: 32 - 33
            record.message_post(
    ...
    def test_message_post_one_inbox_notification(self):
        ...
        with self.assertQueryCount(__system__=23, emp=25):  # com runbot 29 - 34 // test_mail only: 23 - 25
            record.message_post(
...
class TestHeavyMailPerformance(BaseMailPerformance):
    ...
    def test_complex_message_post(self):
        ...
        with self.assertQueryCount(__system__=71, emp=72):  # com runbot: 82 - 85 // test_mail only: 71 - 72
            record.message_post(
    ...
    def test_complex_message_post_template(self):
        ...
        with self.assertQueryCount(__system__=81, emp=82):  # com runbot: 98 - 103 // test_mail only: 81 - 82
    ...
    def test_complex_tracking_assignation(self):
        ...
        with self.assertQueryCount(__system__=39, emp=40):  # com runbot: 51 - 53 // test_mail only: 39 - 40
    ...
    def test_complex_tracking_subscription_create(self):
        ...
        with self.assertQueryCount(__system__=121, emp=122):  # com runbot: 146 - 149 // test_mail only: 121 - 122
            rec = self.env['mail.test.full'].create({
                'name': 'Test',
    ...
    def test_complex_tracking_subscription_subtype(self):
        ...
        self.assertEqual(len(rec.message_ids), 1)
        with self.assertQueryCount(__system__=84, emp=85):  # com runbot: 100 -106 // test_mail only: 84 - 85
            rec.write({
                'name': 'Test2',
                'umbrella_id': self.umbrella.id,
                })
    ...
    def test_complex_tracking_subscription_write(self):
        ...
        with self.assertQueryCount(__system__=92, emp=93):  # test_mail only: 92 - 93
            rec.write({
                'name': 'Test2',
                'umbrella_id': umbrella_id,
                'customer_id': customer_id,
    ...
    def test_complex_tracking_template(self):
        ...
        with self.assertQueryCount(__system__=33, emp=35):  # test_mail only: 33 - 35
            rec.write({
                'name': 'Test2',
                'customer_id': customer_id,
                'user_id': self.env.uid,
...
class TestMailPerformancePost(BaseMailPerformance):
    ...
    def test_complete_message_post(self):
        ...
        with self.assertQueryCount(emp=112):  # com runbot 112 // test_mail only: 110
