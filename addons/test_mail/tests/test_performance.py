...
class TestAdvMailPerformance(TransactionCase):
    ...
    def test_adv_activity_full(self):
        ...
        with self.assertQueryCount(admin=46, emp=51):  # com runbot 44 - 49 // test_mail only: 35 - 40
            model.create({
...
class TestHeavyMailPerformance(TransactionCase):
    ...
    def test_complex_message_post(self):
        ...
        with self.assertQueryCount(admin=131, emp=163):  # com runbot 129 - 161 // test_mail only: 123 - 154
            record.message_post(
    ...
    def test_complex_create_tracking_subscription(self):
        ...
        with self.assertQueryCount(admin=355, emp=412):  # com runbot: 344 - 418 // test_mail only: 337 - 407
