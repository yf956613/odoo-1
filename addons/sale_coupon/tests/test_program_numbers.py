...
class TestSaleCouponProgramNumbers(TestSaleCouponCommon):
    ...
    def setUp(self):
        ...
        self.largeCabinet = self.Product.create({'name': 'Large Cabinet', 'list_price': 320.0, 'standard_price': 800.0, 'taxes_id': False})
        self.conferenceChair = self.Product.create({'name': 'Conference Chair', 'list_price': 16.50, 'standard_price': 14.0, 'taxes_id': False})
        self.pedalBin = self.Product.create({'name': 'Pedal Bin', 'list_price': 47.0, 'standard_price': 10.0, 'taxes_id': False})
        self.drawerBlack = self.Product.create({'name': 'Drawer Black', 'list_price': 25.0, 'standard_price': 20.0, 'taxes_id': False})
        self.largeMeetingTable = self.Product.create({'name': 'Large Meeting Table', 'list_price': 40000.0, 'standard_price': 45000.0, 'taxes_id': False})
