...
options.registry.carousel = options.Class.extend({
    ...
    _rebindEvents: function () {
        ...
        this.$target.find('.carousel-item.text_image, .carousel-item.image_text, .carousel-item.text_only').find('.container > .carousel-caption > div, .container > img.carousel-image').attr('contentEditable', 'true');
    },
});
...
options.registry.collapse = options.Class.extend({
    ...
    onMove: function () {
        ...
        if ($panel.attr('aria-expanded') === 'true') {
            $panel.closest('.s_accordion').find('.collapse[aria-expanded="true"]')
    ...
    _createIDs: function () {
        ...
        var $tablist = this.$target.closest('.s_accordion');
