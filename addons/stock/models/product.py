...
class ProductPackaging(models.Model):
    ...
    _inherit = ['product.packaging', 'company.consistency.mixin']

    product_id = fields.Many2one(domain="['|', ('company_id', '=', False), ('company_id', '=', company_id)]")
    ...
    def _company_consistency_m2o_optional_cid_fields(self):
        res = super(ProductPackaging, self)._company_consistency_m2o_optional_cid_fields()
