        ...
        for line in self:
            ...
            if fpos:
                ...
                if self.env.uid == SUPERUSER_ID and line.order_id.company_id:
                    taxes = fpos.map_tax(line.product_id.taxes_id, product_id=line.product_id.id, partner_id=line.order_id.partner_id.id).filtered(lambda r: r.company_id == line.order_id.company_id)
                else:
                    taxes = fpos.map_tax(line.product_id.taxes_id, product_id=line.product_id.id, partner_id=line.order_id.partner_id.id)
                line.tax_id = taxes
            else:
