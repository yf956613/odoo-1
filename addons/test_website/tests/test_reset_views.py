...
class TestWebsiteResetViews(odoo.tests.HttpCase):
    ...
    def fix_it(self, page, mode='soft'):
        ...
        resp = self.url_open('/portal/reset_template', data)
    ...
    @mute_logger('odoo.addons.portal.models.ir_http')
    ...
    # @mute_logger('odoo.addons.portal.models.ir_http', 'odoo.addons.website.models.ir_ui_view')
