...
class TestPoSCommon(TransactionCase):
    ...
    def open_new_session(self):
        ...
        self.cash_pm = self.pos_session.payment_method_ids.filtered(lambda pm: 'Cash' in pm.name)
        self.bank_pm = self.pos_session.payment_method_ids.filtered(lambda pm: 'Bank' in pm.name)
        self.credit_pm = self.pos_session.payment_method_ids.filtered(lambda pm: 'Credit' in pm.name)
