...
class TestPoSMultipleSaleAccounts(TestPoSCommon):
    ...
    def test_01_check_product_properties(self):
        ...
        self.assertAlmostEqual(self.product1.qty_available, 100)
        self.assertAlmostEqual(self.product2.qty_available, 50)
        self.assertAlmostEqual(self.product3.qty_available, 50)
