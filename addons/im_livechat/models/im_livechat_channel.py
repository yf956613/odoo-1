...
class ImLivechatChannel(models.Model):
    ...
    def _create_mail_channel(self, operator_partner_id, user_id, anonymous_name, country_id=None, operator=None):
    ...
    def _get_mail_channel(self, anonymous_name, previous_operator_id=None, user_id=None, country_id=None):
        ...
        mail_channel = self._create_mail_channel(operator_partner_id, user_id, anonymous_name, country_id, operator)
