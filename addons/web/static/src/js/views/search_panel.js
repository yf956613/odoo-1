...
var SearchPanel = Widget.extend({
     ...
     * @param {boolean} [params.defaultAll=false] if true, select 'All' as value
     *   for each category that has no value specified in params.defaultValues
