...
class TestMenusAdmin(odoo.tests.HttpCase):
    ...
    def test_01_click_everywhere_as_admin(self):
        self.browser_js("/web", "odoo.__DEBUG__.services['web.clickEverywhere']();", "odoo.isReady === true", login="admin", timeout=3600)
...
class TestMenusDemo(odoo.tests.HttpCase):
    ...
    def test_01_click_everywhere_as_demo(self):
        self.browser_js("/web", "odoo.__DEBUG__.services['web.clickEverywhere']();", "odoo.isReady === true", login="demo", timeout=3600)
