odoo.define('mrp.ProgressCard', function (require) {
"use strict";
...
const MrpProgressCard = Widget.extend({
    template: 'mrp.ProgressCard',
    ...
    update(loaded, total) {
        ...
        const $textDivLeft = this.$('.o_mrp_documents_progress_text_left');
        const $textDivRight = this.$('.o_mrp_documents_progress_text_right');
        if (percent === 100) {
