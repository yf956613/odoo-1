        ...
        try:
            ...
            if lang:
                ...
                if cr:
                    ...
                    env = odoo.api.Environment(cr, odoo.SUPERUSER_ID, odoo.SUPERUSER_COMPANY_ID, {})
...
def trans_load_data(cr, fileobj, fileformat, lang, lang_name=None, verbose=True, module_name=None, context=None):
    ...
    env = odoo.api.Environment(cr, odoo.SUPERUSER_ID, odoo.SUPERUSER_COMPANY_ID, context or {})
    Lang = env['res.lang']
    Translation = env['ir.translation']
