...
def decode_smtp_header(smtp_header, escape_names=False):
    ...
    escape_names: we need to name of the parties for commas, quotes and backslash.
    The email_from is used afterwards and given to getadresses, might fail otherwise.
